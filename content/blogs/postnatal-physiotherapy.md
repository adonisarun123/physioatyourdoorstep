---
title: "Postnatal Physiotherapy: Assessment and Exercise Guide"
date: "2026-04-30"
metaTitle: "Postnatal Physiotherapy: Assessment and Exercise Guide"
metaDescription: "Postnatal physiotherapy guide covering assessment, safe exercises, and postpartum management for recovery and strength."
excerpt: "Giving birth is one of the most physically demanding events a body can experience. Yet, the postpartum period often called the “fourth trimester” receives far less clinical attention than pregnancy itself."
coverImage: "/images/blog/postnatal-physiotherapy.jpg"
...
| **DRA Phase** | **Recommended Exercises**                                                            | **Exercises to Avoid**                                                  |
| ------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| Weeks 1–6     | Diaphragmatic breathing, heel slides, pelvic tilts, gentle Kegels                    | Sit-ups, crunches, double-leg lifts, heavy lifting                      |
| Weeks 6–12    | Transverse abdominis activation, glute bridges, modified bird-dog, bodyweight squats | Full planks (if coning occurs), overhead pressing, high-impact movement |
| 3–6 months    | Progressive core loading, functional compound movements, resistance training         | Exercises producing pain, leakage, or midline doming                    |
...
### How soon can I start postnatal physiotherapy after a Caesarean section?

Breathing exercises and ankle pumps can begin within the first 24 hours after a Caesarean. Scar mobilisation usually begins at 6 to 8 weeks once the incision is fully closed. A physiotherapist designs a phased programme that respects the seven-layer tissue healing process while preventing the adhesions and movement restrictions that commonly develop after abdominal surgery.

### What does a postnatal physiotherapy assessment include?

A postnatal physiotherapy assessment is a comprehensive evaluation covering your obstetric history, posture, gait, core muscle function, pelvic floor strength and coordination, scar tissue (if applicable), hip and lower back mobility, and functional movement patterns. It typically takes 45 to 60 minutes and results in a personalised rehabilitation plan with short- and long-term goals.

### How do I know if I have diastasis recti (abdominal separation)?

Common signs include a visible ridge or dome running along the midline of the abdomen during activities like sitting up, a soft bulging at the navel that persists months after delivery, and a sense of core weakness. The definitive diagnosis requires a clinical assessment by a physiotherapist who evaluates both the width of the inter-recti gap and the functional quality of the linea alba under load.

### Is it safe to exercise after a Caesarean section?

Yes, with appropriate guidance. Gentle exercises begin immediately after delivery. More structured exercise, including core strengthening, begins from around 6 to 8 weeks. High-impact activity such as running should be deferred until at least 3 months postpartum and only after a physiotherapy assessment confirms that pelvic floor and core function are sufficient to handle the load.

### Can physiotherapy treat postpartum urinary leakage?

Yes. Pelvic floor muscle training supervised by a physiotherapist is the evidence-based first-line treatment for stress urinary incontinence postpartum, and clinical trials confirm that supervised physiotherapy produces significantly better outcomes than self-directed exercise programmes. Most women experience meaningful improvement within 6 to 12 weeks of consistent, correctly performed pelvic floor rehabilitation. Leakage is common, but it is not something you have to live with.

### When can I return to running after having a baby?

International guidelines (Goom, Donnelly, and Brockwell, 2019) recommend waiting at least 3 months postpartum before resuming running, and only after a physiotherapy assessment confirms specific benchmarks: single-leg balance for 10 seconds, 20 single-leg calf raises and bridges, absence of urinary leakage during impact, and a normal gait pattern. Returning before meeting these criteria significantly increases the risk of pelvic floor dysfunction and running-related injury.

### Does postnatal physiotherapy help with postpartum back pain?

Absolutely. Postpartum lower back pain and pelvic girdle pain are among the most common reasons women seek postnatal physiotherapy. Treatment involves manual therapy to the sacroiliac joints and lumbar spine, targeted exercises to rebuild core stability and gluteal strength, postural correction advice, and education on safe movement for daily activities such as lifting the baby, feeding, and carrying.

### Is at-home postnatal physiotherapy as effective as clinic-based treatment?

Yes. The clinical effectiveness of physiotherapy is determined by the skill of the therapist and the quality of the treatment plan, not the location. At-home physiotherapy also allows the therapist to observe and correct the actual positions and activities you perform every day with your baby, which is a distinct clinical advantage. For new mothers, eliminating travel also improves adherence and consistency, both of which are critical to a good recovery outcome.
